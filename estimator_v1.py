...
""" 
    In this version, MHE can start from the first online data is collected. 
    If the buffers are not full, we just adopt the exit data to calculate
    the estimation.
"""
